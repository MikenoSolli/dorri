...
echo"<script>console.log('".$id."');</script>";
    ...
    $selectQuery =  "SELECT fine.id, fine.fine,fine.Fine_date,fine.person, fine.cost,person.Name, fine.Status from fine join person on fine.person=person.id where person.id='".$id."' and Status='no';";
