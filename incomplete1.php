...
if(mysqli_connect_errno()){
    ...
    $selectQuery = "SELECT fine.id, fine.fine,fine.Fine_date,fine.person, fine.cost, person.Name from fine join person on fine.person=person.id where fine.status='no' ";
